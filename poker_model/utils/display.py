...
def show_hand(img, hand_text):
    """Draw result below of the fps."""
    font = cv2.FONT_HERSHEY_PLAIN
    line = cv2.LINE_AA
    cv2.putText(img, hand_text, (11, 60), font, 2.0, (32, 32, 32), 8, line)
    cv2.putText(img, hand_text, (10, 60), font, 2.0, (240, 240, 240), 2, line)
    return img
